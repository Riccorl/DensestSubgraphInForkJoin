...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        //String filename = "data/roadNet-CA.txt"; // 0
        //String filename = "data/as-skitter.txt";
        //String filename = "data/cit-Patents.txt"; // 3858266
        String filename = "data/wiki-topcats.txt"; // 0
        //String filename = "data/soc-LiveJournal1.txt"; // 0
        ...
        UndirectedGraphArrays graphArrays = new UndirectedGraphArrays(filename);
        for (int i = 0; i < 1; i++) {
        ...
        System.out.println(graphArrays.getMaxNodeValue());
